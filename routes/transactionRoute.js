...
router.post('/deposit', auth, authorizeRoles('shipper', 'driver', 'admin','super-admin'),walletController.depositFunds);
router.post('/pay-driver', auth, authorizeRoles('shipper', 'driver', 'admin','super-admin'),walletController.payDriver);
